---
title: "Mi 2025 con Cursor AI: Top 1% en Chile, Top 7% Mundial y 4 Billones de Tokens en Ingeniería de Software"
date: "08-01-2026"
...
![Notificación de Cursor Year in Review 2025 indicando pertenencia al Top 7% mundial de usuarios más activos](/images/blog/cursor3.jpg)
...
![Resumen detallado de métricas de Cursor 2025: 4.00B tokens, Top 7% de uso, 15.4K agentes, 2.5K tabs, 40 días de racha y modelos Claude Sonnet](/images/blog/cursor.jpg)
...
![Correo personal de Ben Lang invitando a Carlos Baeza a Café Cursor en Santiago por estar en el Top 1% de usuarios de Chile](/images/blog/cursor2.jpg)

```mermaid
flowchart LR
    A[4.00B Tokens en 2025] --> B[Top 7% Global]
    A --> C[Top 1% Chile / Stgo]
    C --> D[Invitación Oficial Ben Lang]
    D --> E[Café Cursor Santiago]
    E --> F[Networking con Equipo Cursor & Power Users]
```
...
![Gráfico mensual de uso de tecla Tab en Cursor mostrando picos de productividad en mayo y junio](/images/blog/cursor4.jpg)
...
```mermaid
graph TD
    subgraph Entrada & Contexto
        R[Repositorio / Código Fuente] --> IDX[Indexación Semántica de Cursor]
        RULES[.cursorrules & System Prompts] --> CTX[Context Orchestrator]
        DOCS[Documentación & APIs] --> CTX
    end

    subgraph Procesamiento & Modelos
        CTX --> MDLS{Selector de Modelos}
        MDLS -->|Lógica & Razonamiento| C37[Claude 3.7 / 4 Sonnet]
        MDLS -->|Completado Rápido| TAB[Cursor Tab / Fast Engine]
        MDLS -->|Decisión Dinámica| AUTO[Modo Auto]
    end

    subgraph Ejecución & Agentes
        C37 --> AGT[Cursor Composer / Agent Mode]
        AGT -->|15.4K Ejecuciones| ACT[Edición Multi-archivo & Terminal]
        ACT --> TEST[Validación & Tests Locales]
        TEST -->|Feedback Loop| AGT
    end

    subgraph Entrega
        TEST --> OUT[Código Listo para Producción]
    end
```
